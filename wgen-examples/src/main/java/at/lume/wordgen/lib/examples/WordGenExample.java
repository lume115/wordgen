...
/**
 * 
 * Example that generates 6 x 1000 words and exports them to .txt files
 * 
 * pseudo -english, -norwegian and -polish use rules files generated by {@link Scanner}  
 *
 * @author Lukasz Budryk
 */
public class WordGenExample {

	public static void main(String[] args) throws IOException {
		final WordGenExample ngExample = new WordGenExample();
	...
	public void testEnglish() throws IOException {
		...
		FilesUtil.writeLines(words, new File("example_en.txt"));
		System.out.println("time needed for pseudo-english: " + (System.currentTimeMillis() - start));
	}
	...
	public void testNorwegian() throws IOException {
		...
		FilesUtil.writeLines(words, new File("example_nor.txt"));
		System.out.println("time needed for pseudo-norwegian: " + (System.currentTimeMillis() - start));
	}
